...
class OpenFile {
  public:
    int type;
    char* name;
    OpenFile(int f) { file = f; currentOffset = 0; this->type = 0;this->name = NULL; }	// open the file
    OpenFile(int f,int type) { file = f; currentOffset = 0; this->type = type;this->name = NULL; }	// open the file
    OpenFile(int f,int type,char* na) { file = f; currentOffset = 0; this->type = type;this->name=na; }	// open the file
...
//    int Length() { Lseek(file, 0, 2); return Tell(file); } //Length defualt
